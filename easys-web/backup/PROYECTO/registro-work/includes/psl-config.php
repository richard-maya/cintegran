...
define("USER", "easysweb_admin"); 			// The database username. 
define("PASSWORD", "Admin1986"); 	// The database password. 
define("DATABASE", "easysweb_secure_login");             // The database name.
