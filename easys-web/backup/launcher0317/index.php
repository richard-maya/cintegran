...
<html><head>
    ...
    <meta name="author" content="L.I.A. Adrián Rebollar, Ricardo Maya">
    ...
    <div class="container">
      ...
      <!-- CURRENCY -->
			<div class="half-unit">
	      		...
	      		<hr>
	      		<div class="cont">
					<p><!--<img src="assets/img/up.png" alt="">--> <bold>$ 13.82</bold> | MNX</p>
				</div>
			</div>
	  ...
	  <!-- PURCHASES AND EXPENSES -->
        <div class="col-sm-3 col-lg-3">
      		...
      		<hr>
			    <div class="cont">
					<p><bold>$879</bold> | <ok>Compras</ok></p>
					<br>
					<p><bold>$377</bold> | <bad>Gastos</bad></p>
					<br>
					<p><bold>+ $502</bold> | Balance</p>
					<br>
      	...
      	<div class="container">
      		<div class="row">
                ...
                <p>
      			...
      			<p>Copyright &copy; 2016 - Todos los derechos reservados<br>Grupo Empresarial Cintegran - EASYSWEB</p>
      			</div>
