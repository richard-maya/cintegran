    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12">
                <!-- <ul>
                    ...
                    <li>
                        Los nombres de usuario pueden contener sólo dígitos, letras mayúsculas y minúsculas.
                    </li>
                ...
                <p class="lead">Registra tu RFC o Número de Cliente, ¡Recuerda que debes ser Cliente EASyS Web!</p>
            </div>
        </div>

        <!-- <form method="post" name="registration_form" action="<?php echo esc_url($_SERVER['PHP_SELF']); ?>">
            No. Cliente: <input type="text"
                name="nocliente" id="nocliente" maxlength="3"/>
            RFC: <input type="text"
        ...
        <form method="post" name="registration_form" action="<?php echo esc_url($_SERVER['PHP_SELF']); ?>">
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" name="nocliente" id="nocliente" maxlength="3" placeholder="No. Cliente">
            </div>
            <div class="form-group col-md-4">
