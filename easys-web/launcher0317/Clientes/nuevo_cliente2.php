            ...
            <div class="tab-pane fade show active" id="required-info" role="tabpanel" aria-labelledby="required-tab">
                <form action="" method="post" name="required-form" enctype="multipart/form-data" class="form" role="form">
                    ...
                    <div class="form-group row justify-content-center">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control wow fadeIn" id="razonSocial" placeholder="" required data-toggle="tooltip" data-placement="bottom" title="Nombre o Razón Social" maxlength="99">
                        </div>
                    </div>
                    ...
                    <div class="form-group row justify-content-center">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control wow fadeIn" id="rfc" placeholder="" maxlength="13" required data-toggle="tooltip" data-placement="bottom" title="RFC">
                        </div>
                    </div>
                    ...
                    <div class="form-group row justify-content-center">
                        ...
                        <div class="col-md-4">
                            <input type="number" class="form-control wow fadeIn" id="cp" placeholder="" maxlength="5" required data-toggle="tooltip" data-placement="bottom" title="Código Postal">
                        </div>
                    </div>-->

                    <!-- Uso CFDi -->
                    <div class="form-group row justify-content-center">
                        <label for="uso-cfdi" class="col-md-2 col-form-label wow fadeInUp">Código Postal *</label>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select class="custom-select wow fadeIn" id="estado">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select class="custom-select wow fadeIn" id="ciudad">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select class="custom-select wow fadeIn" id="municipio">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control wow fadeIn" id="colonia" placeholder="" data-toggle="tooltip" data-placement="bottom" title="Colonia">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control wow fadeIn" id="calle" placeholder="" data-toggle="tooltip" data-placement="bottom" title="Calle">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="email" class="form-control wow fadeIn" id="correo" placeholder="" data-toggle="tooltip" data-placement="bottom" title="Correo Electrónico">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="tel" class="form-control wow fadeIn" id="telefono" placeholder="" maxlength="10" data-toggle="tooltip" data-placement="bottom" title="Teléfono">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select class="custom-select wow fadeIn" id="giro">
                                        <option selected>Selecciona tu municipio</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="number" class="form-control wow fadeIn" id="exterior" placeholder="" maxlength="5" data-toggle="tooltip" data-placement="bottom" title="Número Exterior">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="number" class="form-control wow fadeIn" id="interior" placeholder="" maxlength="5" data-toggle="tooltip" data-placement="bottom" title="Número Interior">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-check form-check-inline">
                                        ...
                                        <input class="form-check-input wow fadeIn" type="radio" name="mexico" id="mexico" value="mexico" checked>
                                        México
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                        <input class="form-check-input wow fadeIn" type="radio" name="otro" id="otro" value="otro">
                                        Otro
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select class="custom-select wow fadeIn" id="residencia-fiscal">
                                        <option selected>Selecciona</option>
                                        <option value="1">…</option>
                                        <option value="2">…</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="number" class="form-control wow fadeIn" id="identificacion-fiscal" placeholder="" maxlength="40" data-toggle="tooltip" data-placement="bottom" title="Identificación Fiscal">
                                </div>
                            </div>
